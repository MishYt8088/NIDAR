...
from pymavlink import mavutil # Needed for velocity commands
import time
import math
...
# --------------------------------------------------
# SEND VELOCITY (For Vision Alignment)
# --------------------------------------------------
def send_body_velocity(vehicle, velocity_x, velocity_y, velocity_z):
    """
    Moves the drone based on BODY axis (Forward/Right/Down).
    velocity_x: Positive = Forward, Negative = Backward
    ...
    msg = vehicle.message_factory.set_position_target_local_ned_encode(
        ...
        mavutil.mavlink.MAV_FRAME_BODY_NED, # Frame: Body-relative
